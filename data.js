...
sgs.HERO = [
    ["曹操", 4, ["护驾", "奸雄"], "魏", 1, "caocao"],
    ["张辽", 4, ["突袭"], "魏", 1, "zhangliao"],
    ["郭嘉", 3, ["天妒", "遗计"], "魏", 1, "guojia"],
    ["夏侯淳", 4, ["刚烈"], "魏", 1, "xiahoudun"],
    ["司马懿", 3, ["反馈", "鬼才"], "魏", 1, "simayi"],
    ["许褚", 4, ["裸衣"], "魏", 1, "xuchu"],
    ["甄姬", 3, ["洛神", "倾国"], "魏", 0, "zhenji"],
    ["刘备", 4, ["激将", "仁德"], "蜀", 1, "liubei"],
    ["关羽", 4, ["武圣"], "蜀", 1, "guanyu"],
    ["张飞", 4, ["咆哮"], "蜀", 1, "zhangfei"],
    ["赵云", 4, ["龙胆"], "蜀", 1, "zhaoyun"],
    ["马超", 4, ["马术", "铁骑"], "蜀", 1, "machao"],
    ["诸葛亮", 3, ["观星", "空城"], "蜀", 1, "zhugeliang"],
    ["黄月英", 3, ["集智", "奇才"], "蜀", 0, "huangyueying"],
    ["孙权", 4, ["救援", "制衡"], "吴", 1, "sunquan"],
    ["周瑜", 3, ["反间", "英姿"], "吴", 1, "zhouyu"],
    ["吕蒙", 4, ["克己"], "吴", 1, "lvmeng"],
    ["陆逊", 3, ["连营", "谦逊"], "吴", 1, "luxun"],
    ["甘宁", 4, ["奇袭"], "吴", 1, "ganling"],
    ["黄盖", 4, ["苦肉"], "吴", 1, "huanggai"],
    ["大乔", 3, ["国色", "流离"], "吴", 0, "daqiao"],
    ["孙尚香", 3, ["结姻", "枭姬"], "吴", 0, "sunshangxiang"],
    ["吕布", 4, ["无双"], "群", 1, "lvbu"],
    ["华佗", 3, ["急救", "青囊"], "群", 1, "huatuo"],
    ["貂蝉", 3, ["闭月", "离间"], "群", 0, "diaochan"],
];
...
*/
sgs.CARD = [
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '7', 'id': 'card13'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '8', 'id': 'card15'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '8', 'id': 'card16'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '9', 'id': 'card17'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '9', 'id': 'card18'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '10', 'id': 'card19'},
    { 'name': '杀', 'color': sgs.COLOR_SPADE, 'digit': '10', 'id': 'card20'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '2', 'id': 'card55'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '3', 'id': 'card57'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '4', 'id': 'card59'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '5', 'id': 'card61'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '6', 'id': 'card63'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '7', 'id': 'card65'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '8', 'id': 'card67'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '8', 'id': 'card68'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '9', 'id': 'card69'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '9', 'id': 'card70'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '10', 'id': 'card71'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '10', 'id': 'card72'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '11', 'id': 'card73'},
    { 'name': '杀', 'color': sgs.COLOR_CLUB, 'digit': '11', 'id': 'card74'},
    { 'name': '杀', 'color': sgs.COLOR_HEART, 'digit': '10', 'id': 'card45'},
    { 'name': '杀', 'color': sgs.COLOR_HEART, 'digit': '10', 'id': 'card46'},
    { 'name': '杀', 'color': sgs.COLOR_HEART, 'digit': '11', 'id': 'card47'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '6', 'id': 'card89'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '7', 'id': 'card91'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '8', 'id': 'card93'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '9', 'id': 'card95'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '10', 'id': 'card97'},
    { 'name': '杀', 'color': sgs.COLOR_DIAMOND, 'digit': '13', 'id': 'card103'},
    { 'name': '闪', 'color': sgs.COLOR_HEART, 'digit': '2', 'id': 'card29'},
    { 'name': '闪', 'color': sgs.COLOR_HEART, 'digit': '2', 'id': 'card30'},
    { 'name': '闪', 'color': sgs.COLOR_HEART, 'digit': '13', 'id': 'card51'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '2', 'id': 'card81'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '2', 'id': 'card82'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '3', 'id': 'card83'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '4', 'id': 'card85'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '5', 'id': 'card87'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '6', 'id': 'card90'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '7', 'id': 'card92'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '8', 'id': 'card94'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '9', 'id': 'card96'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '10', 'id': 'card98'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '11', 'id': 'card99'},
    { 'name': '闪', 'color': sgs.COLOR_DIAMOND, 'digit': '11', 'id': 'card100'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '3', 'id': 'card31'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '4', 'id': 'card33'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '6', 'id': 'card37'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '7', 'id': 'card39'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '8', 'id': 'card41'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '9', 'id': 'card43'},
    { 'name': '桃', 'color': sgs.COLOR_HEART, 'digit': '12', 'id': 'card49'},
    { 'name': '桃', 'color': sgs.COLOR_DIAMOND, 'digit': '12', 'id': 'card101'},
    { 'name': '诸葛连弩', 'color': sgs.COLOR_CLUB, 'digit': '1', 'id': 'card54'},
    { 'name': '诸葛连弩', 'color': sgs.COLOR_DIAMOND, 'digit': '1', 'id': 'card80'},
    { 'name': '雌雄双股剑', 'color': sgs.COLOR_SPADE, 'digit': '2', 'id': 'card4'},
    { 'name': '青釭剑', 'color': sgs.COLOR_SPADE, 'digit': '6', 'id': 'card12'},
    { 'name': '青龙偃月刀', 'color': sgs.COLOR_SPADE, 'digit': '5', 'id': 'card9'},
    { 'name': '丈八蛇矛', 'color': sgs.COLOR_SPADE, 'digit': '12', 'id': 'card24'},
    { 'name': '贯石斧', 'color': sgs.COLOR_DIAMOND, 'digit': '5', 'id': 'card88'},
    { 'name': '方天画戟', 'color': sgs.COLOR_DIAMOND, 'digit': '12', 'id': 'card102'},
    { 'name': '麒麟弓', 'color': sgs.COLOR_HEART, 'digit': '5', 'id': 'card35'},
    { 'name': '八卦阵', 'color': sgs.COLOR_SPADE, 'digit': '2', 'id': 'card3'},
    { 'name': '八卦阵', 'color': sgs.COLOR_CLUB, 'digit': '2', 'id': 'card56'},
    { 'name': '绝影', 'color': sgs.COLOR_SPADE, 'digit': '5', 'id': 'card10'},
    { 'name': '的卢', 'color': sgs.COLOR_CLUB, 'digit': '5', 'id': 'card62'},
    { 'name': '爪黄飞电', 'color': sgs.COLOR_HEART, 'digit': '13', 'id': 'card52'},
    { 'name': '赤兔', 'color': sgs.COLOR_HEART, 'digit': '5', 'id': 'card36'},
    { 'name': '大宛', 'color': sgs.COLOR_SPADE, 'digit': '13', 'id': 'card26'},
    { 'name': '紫骍', 'color': sgs.COLOR_DIAMOND, 'digit': '13', 'id': 'card104'},
    { 'name': '五谷丰登', 'color': sgs.COLOR_HEART, 'digit': '3', 'id': 'card32'},
    { 'name': '五谷丰登', 'color': sgs.COLOR_HEART, 'digit': '4', 'id': 'card34'},
    { 'name': '桃园结义', 'color': sgs.COLOR_HEART, 'digit': '1', 'id': 'card28'},
    { 'name': '南蛮入侵', 'color': sgs.COLOR_SPADE, 'digit': '7', 'id': 'card14'},
    { 'name': '南蛮入侵', 'color': sgs.COLOR_SPADE, 'digit': '13', 'id': 'card25'},
    { 'name': '南蛮入侵', 'color': sgs.COLOR_CLUB, 'digit': '7', 'id': 'card66'},
    { 'name': '万箭齐发', 'color': sgs.COLOR_HEART, 'digit': '1', 'id': 'card27'},
    { 'name': '决斗', 'color': sgs.COLOR_SPADE, 'digit': '1', 'id': 'card1'},
    { 'name': '决斗', 'color': sgs.COLOR_CLUB, 'digit': '1', 'id': 'card53'},
    { 'name': '决斗', 'color': sgs.COLOR_DIAMOND, 'digit': '1', 'id': 'card79'},
    { 'name': '无中生有', 'color': sgs.COLOR_HEART, 'digit': '7', 'id': 'card40'},
    { 'name': '无中生有', 'color': sgs.COLOR_HEART, 'digit': '8', 'id': 'card42'},
    { 'name': '无中生有', 'color': sgs.COLOR_HEART, 'digit': '9', 'id': 'card44'},
    { 'name': '无中生有', 'color': sgs.COLOR_HEART, 'digit': '11', 'id': 'card48'},
    { 'name': '顺手牵羊', 'color': sgs.COLOR_SPADE, 'digit': '3', 'id': 'card6'},
    { 'name': '顺手牵羊', 'color': sgs.COLOR_SPADE, 'digit': '4', 'id': 'card8'},
    { 'name': '顺手牵羊', 'color': sgs.COLOR_SPADE, 'digit': '11', 'id': 'card21'},
    { 'name': '顺手牵羊', 'color': sgs.COLOR_DIAMOND, 'digit': '3', 'id': 'card84'},
    { 'name': '顺手牵羊', 'color': sgs.COLOR_DIAMOND, 'digit': '4', 'id': 'card86'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_SPADE, 'digit': '3', 'id': 'card5'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_SPADE, 'digit': '4', 'id': 'card7'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_SPADE, 'digit': '12', 'id': 'card23'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_CLUB, 'digit': '3', 'id': 'card58'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_CLUB, 'digit': '4', 'id': 'card60'},
    { 'name': '过河拆桥', 'color': sgs.COLOR_HEART, 'digit': '12', 'id': 'card50'},
    { 'name': '借刀杀人', 'color': sgs.COLOR_CLUB, 'digit': '12', 'id': 'card75'},
    { 'name': '借刀杀人', 'color': sgs.COLOR_CLUB, 'digit': '13', 'id': 'card77'},
    { 'name': '无懈可击', 'color': sgs.COLOR_SPADE, 'digit': '11', 'id': 'card22'},
    { 'name': '无懈可击', 'color': sgs.COLOR_CLUB, 'digit': '12', 'id': 'card76'},
    { 'name': '无懈可击', 'color': sgs.COLOR_CLUB, 'digit': '13', 'id': 'card78'},
    { 'name': '无懈可击', 'color': sgs.COLOR_DIAMOND, 'digit': '12', 'id': 'card108'},
    { 'name': '乐不思蜀', 'color': sgs.COLOR_SPADE, 'digit': '6', 'id': 'card11'},
    { 'name': '乐不思蜀', 'color': sgs.COLOR_CLUB, 'digit': '6', 'id': 'card64'},
    { 'name': '乐不思蜀', 'color': sgs.COLOR_HEART, 'digit': '6', 'id': 'card38'},
    { 'name': '闪电', 'color': sgs.COLOR_SPADE, 'digit': '1', 'id': 'card2'},
    { 'name': '闪电', 'color': sgs.COLOR_HEART, 'digit': '12', 'id': 'card106'},
    { 'name': '寒冰剑', 'color': sgs.COLOR_SPADE, 'digit': '2', 'id': 'card105'},
    { 'name': '仁王盾', 'color': sgs.COLOR_CLUB, 'digit': '2', 'id': 'card107'},
];
...
sgs.IDENTITY_INDEX_MAPPING = {
    ...
    "pinyin": {  0: "lord", 1: "loyalist", 2: "traitor", 3: "rebel" },
};
